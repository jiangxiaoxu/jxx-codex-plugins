...
| `context-window-rollover-reminder` | Guides context rollover on Windows through PostToolUse reminders at 300K/350K/400K tokens for `gpt-5.6-sol` and `gpt-6-astra`, and 350K/400K/450K for other models. A skill queries context usage and inspects, sets, or resets persistent per-thread thresholds on request. |
