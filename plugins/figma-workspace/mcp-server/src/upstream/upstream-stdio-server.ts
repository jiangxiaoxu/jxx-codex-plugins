...
export function createFigmaWorkspaceUpstreamStdioServer(
  options: FigmaWorkspaceUpstreamStdioServerOptions = {},
): {
  server: Server;
  client: FigmaUpstreamMcpProxyClient;
} {
  ...
  const server = new Server(
    ...
    },
    {
      ...
      instructions:
        "Transparent stdio MCP bridge for the official Figma remote MCP server. OAuth is read from the local figma-workspace cache by default.",
    },
  );
